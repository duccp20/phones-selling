...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDetailsDTO create(OrderCreationDTO orderCreationDTO) {
        ...
        Promotion promotion = promotionRepository.findById(orderCreationDTO.getIdPromotion()).orElseThrow(
        ...
        orders.setReceiveDate(java.sql.Timestamp.valueOf(LocalDateTime.now()));
